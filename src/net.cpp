...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Otacoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"otacointools.com", "192.168.137.186"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"otacointools.com", "testnet-seed.otacointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Otacoin is probably already running."), addrBind.ToString().c_str());
        else
